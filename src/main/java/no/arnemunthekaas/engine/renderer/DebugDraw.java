...
public class DebugDraw {
    private static final int MAX_LINES = 2000; // maximum drawable lines
    ...
    // Add Circle methods
    // ==================================================================
    public static void addCircle(Vector2f center, float rad, Vector3f color, int lifetime) {
        Vector2f[] points = new Vector2f[20];
        int increment = 360 / points.length;
        int currentAngle = 0;

        for( int i = 0; i < points.length; i++) {
            Vector2f tmp = new Vector2f(rad, 0);
    ...
    public static void addCircle(Vector2f center, float rad, Vector3f color) {
        addCircle(center, rad, color, 1);
    }

    public static void addCircle(Vector2f center, float rad) {
        addCircle(center, rad, new Vector3f(0,1,0));
    }
}
